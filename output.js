const data = {
  HTML: [
    {
      question: "What is HTML and what are it's basic components?",
      answer:
    ...
    {
      question: "What is the difference between div element and span element?",
      answer:
    ...
    {
      question: "What are the different types of input field in HTML?",
      answer:
    ...
    {
      question: "What is the difference between \\<link> tag and \\<a> tag?",
      answer:
    ...
    },
    {
      ...
      explanation:
        "1. It has multi media support 2. Improved performance (faster loading) 3. Better accessibility",
    },
    {
    ...
    {
      question:
        'What is the difference between HTML form\'s "action" and "method" attributes?',
      answer:
    ...
    {
      question: "What is the purpose of \\<head> tag?",
      answer:
    ...
    {
      question: "What is the purpose of the \\<fieldset> tag in HTML?",
      answer:
        "Fieldset is used to group related elements in a form. The \\<fieldset> tag draws a box around the related elements.",
      explanation: "",
    },
    {
      question: "what is the difference between HTML tag and HTML element?",
      answer:
        "HTML tag is just opening or closing entity. For example \\<p> and \\</p> are called HTML tags. <br />",
      explanation:
        "HTML element consists of opening tag, closing tag and content(optional for content-less tags). For example: \\<p> This is the content \\</p>, this complete thing is called HTML element.  ## Day 6",
    },
    {
      question: "How do you change the color of bullets?",
      answer:
    ...
    {
      question: "What will happen if we don't put \\<!Doctype HTML> tag?",
      answer:
    ...
    {
      question: 'What is the use of "target" attribute in HTML?',
      answer:
        'The "target" attribute is used to specify where to open the linked document when the user clicks on the hyperlink.',
      explanation: "",
    },
    {
      question: 'What is the use of "em" tag?',
      answer:
        'The "em" tag is a semantic tag which is used to apply emphasis to a word or phrase within a paragraph. <br />',
      explanation:
        'Example: The sentence "I really enjoyed cycling" could be written using the "em" tag to emphasize the word "really": "I \\<em>really \\</em> enjoyed the concert last night."  ## Day 7',
    },
    {
      question: "What is the purpose of \\<header> tag?",
      answer:
    ...
    {
      question: "What is the purpose of \\<footer> tag?",
      answer:
    ...
    {
      question: "What is the purpose of \\<figure> tag?",
      answer:
    ...
    {
      question: "What is the use of \\<option> tag?",
      answer:
    ...
    {
      question: "Details about all tags used in HTML table.",
      answer:
        "| Tag Name    | Definition                                                     |",
      explanation:
    ...
    {
      question: "What is the purpose of \\<legend> tag?",
      answer:
    ...
    {
      question:
        "What is the purpose of the \\<picture> element in HTML5, and how is it used to optimize images?",
      answer:
    ...
    },
    {
      ...
      answer: "There are 3 ways to apply CSS styles to a web page. They are:",
      explanation: "1. Inline CSS 2. Internal CSS 3. External CSS",
    },
    {
      question: "What are some new features in CSS3?",
      answer: "Some new features of CSS3 are:",
      explanation:
        "1. New selectors. 2. Pseudo-classes 3. Rounded Corners(Border-radius) 4. Text shadow 5. Gradient, etc",
    },
    {
    ...
    {
      question: "What is universal selector in css?",
      answer:
    ...
    {
      question: "Explain box model in CSS.",
      answer:
    ...
    {
      question: "Explain the CSS display property and its values.",
      answer:
    ...
    {
      question: "Explain the CSS float property and its values.",
      answer:
    ...
    {
      question: "What is the CSS clear property?",
      answer:
    ...
    {
      question: "What are CSS pseudo-classes? Give some examples.",
      answer:
    ...
    {
      question: "How do you define a CSS animation?",
      answer:
    ...
    {
      question: "How do you trigger a CSS animation to start and stop?",
      answer:
    ...
    {
      question: "How do you create a responsive CSS animation?",
      answer:
    ...
    {
      question: "How do you optimize CSS animations for performance?",
      answer:
    ...
    {
      question:
        "How do you debug CSS animations and troubleshoot common issues, such as animations not playing or playing too quickly?",
      answer:
    ...
    {
      question: "What is transition in CSS?",
      answer:
    ...
    {
      question: "Can you specify multiple CSS transitions for an element?",
      answer:
    ...
    {
      question:
        "What is the difference between flex-grow and flex-shrink properties in Flexbox?",
      answer:
    ...
    {
      question:
        "What is the difference between flex-wrap: nowrap and overflow: hidden in CSS?",
      answer:
    ...
    {
      question:
        "What is the `gap` property in Flexbox, and how is it used to add spacing between flex items?",
      answer:
    ...
    {
      question:
        "How do you use the grid-template-columns and grid-template-rows properties to define the size and number of columns and rows in a grid?",
      answer:
      ...
      explanation: "``` grid-template-columns: 100px 50% 1fr; ```",
    },
    {
      question: "How do you specify the number of columns in a grid using CSS?",
      answer:
    ...
    {
      question: "How do you align items within a grid using CSS?",
      answer:
    ...
    {
      question:
        "What is the difference between grid-row and grid-column in CSS Grid?",
      answer:
    ...
    {
      question:
        "What is the purpose of the `transition-property` property in CSS transitions?",
      answer:
    ...
    {
      question:
        "What is the function of the `transition-timing-function` property in CSS transitions?",
      answer:
    ...
    {
      question: "How do you delay the start of a CSS transition?",
      answer:
    ...
    {
      question: "How do you apply a transition to multiple properties at once?",
      answer:
    ...
    {
      question: "What are CSS 2D Transforms?",
      answer:
    ...
    {
      question:
        "Can you use negative values with CSS 2D transforms? If so, what effect do they have?",
      answer:
    ...
    {
      question: "What are the properties of CSS 2D transform?",
      answer: "The properties of CSS 2D Transforms are:",
      explanation:
        "1. transform: specifies the transformation functions to be applied to an element 2. transform-origin: specifies the point around which the transformation should occur 3. translate: moves an element along the x-axis and/or y-axis 4. rotate: rotates an element clockwise or counterclockwise around a given point 5. scale: increases or decreases the size of an element 6. skew: skews an element along the x-axis and/or y-axis",
    },
    {
      question:
    ...
    {
      question:
        "What is the difference between the `translate()` and `rotate()` functions?",
      answer:
    ...
    {
      question: "What are the properties of CSS 3D transform?",
      answer: "The properties of CSS 3D Transforms are:",
      explanation:
        "1. transform-style: determines whether an element's children are transformed in 3D space 2. perspective: determines the distance between the viewer and the element, affecting the appearance of 3D transforms 3. perspective-origin: specifies the origin point of the perspective 4. transform: applies a 3D transformation to an element, such as rotateX(), rotateY(), rotateZ(), translateX(), translateY(),translateZ(), scale(), and skew() 5. transform-origin: specifies the origin point of the transformation 6. backface-visibility: determines whether or not the back face of an element should be visible when the element is rotated.",
    },
    {
      question: "What is the difference between RGB and RGBA colors?",
      answer:
    ...
    {
      question:
        "How does color contrast applies to accessibility in web design?",
      answer:
    ...
    {
      question:
        "What are some important considerations when using text effects?",
      answer:
    ...
    {
      question: "What is the :not() pseudo-class used for in CSS?",
      answer:
    ...
    {
      question: "What is the :visited pseudo-class used for in CSS?",
      answer:
    ...
    {
      question: "What is the :checked pseudo-class used for in CSS?",
      answer:
    ...
    {
      question: "What is the @media rule in CSS?",
      answer:
    ...
    {
      question:
        "What is the difference between fluid and fixed layouts in CSS?",
      answer:
    ...
    {
      question:
        "What is the difference between responsive and adaptive design in CSS?",
      answer:
    ...
    {
      question:
        "How do you optimize responsive images for faster loading in CSS?",
      answer:
    ...
    {
      question: "How does calc() work in css?",
      answer:
        "The CSS3 calc() function allows us to perform mathematical operations on property values.",
      explanation: "Example: `div{width: calc(100px + 50px)}`",
    },
    {
      question: "What is the overflow property in CSS used for?",
      answer:
    ...
    {
      question: "Are quotes mandatory in URL\u2019s?",
      answer:
        "Quotes are optional in URL\u2019s, and it can be single or double.",
      explanation: "",
    },
    {
      question: "Explain what are web-safe fonts and fallback fonts.",
      answer:
    ...
    {
      question: "What is the purpose of CSS content property?",
      answer:
    ...
    {
      question: "How can we create custom cursor in CSS?",
      answer:
    ...
    {
      question: 'What is the "line-height" property in CSS?',
      answer:
    ...
    {
      question:
        "Which CSS property is used to capitalize text or convert text to uppercase or lowercase letters?",
      answer:
        "The text-transform property is used to capitalize text or convert text to uppercase or lowercase letters.",
      explanation: "",
    },
    {
      question: "What is word-wrap property in CSS3?",
      answer:
    ...
    {
      question: "Describe \u2018rule set\u2019 in CSS?",
      answer:
    ...
    {
      question: "How can you create a CSS-only dropdown menu?",
      answer:
    ...
    {
      question:
        "What are the potential drawbacks of using CSS frameworks such as Bootstrap?",
      answer:
    ...
    {
      question:
        "How do you customize TailwindCSS to match a specific design system or brand guidelines?",
      answer:
    ...
    {
      question:
        "Can you explain the difference between utility classes and component classes in TailwindCSS?",
      answer:
    ...
    {
      question:
        "How do you optimize the file size of TailwindCSS in a production environment?",
      answer:
    ...
    {
      question:
        "What are some common performance issues with TailwindCSS, and how do you optimize performance in your projects?",
      answer:
    ...
    {
      question:
        "What is the difference between a CSS preprocessor and a post-processor?",
      answer:
    ...
    {
      question:
        "Can you describe a situation where you would choose not to use Sass?",
      answer:
    ...
    {
      question: "What are mixins in Sass?",
      answer:
      ...
      explanation:
        "``` @mixin my-text-style { font-size: 16px; font-weight: bold; }  /* we can use the whole style like this now */  h1 { @include my-text-style; } ```",
    },
    {
      question: "What is Sass inheritance?",
      answer:
      ...
      explanation:
        "``` @mixin button-style($bg-color, $text-color) { background-color: $bg-color; color: $text-color; display: inline-block; padding: 8px 16px; }  // Use the mixin to create different button styles  .button-primary { @include button-style(#007bff, #fff); }  .button-secondary { @include button-style(#6c757d, #fff); } ```",
    },
    {
      question: "How do you use 'if' statements in SCSS?",
      answer:
        "In SCSS, you can use the @if directive to add conditional logic to your styles. Example:",
      explanation:
        "``` //declaring variable $background-color: #333;  body {  @if $background-color == #333 { background-color: $background-color;  } @else {  background-color: #fff; } } ```  # Day 30",
    },
    {
      question:
    ...
    {
      question:
        "How do you balance the need for visual aesthetics with the need for website or application functionality?",
      answer:
    ...
    {
      question:
        "How do you ensure that your CSS is optimized for search engine optimization (SEO)?",
      answer:
    ...
    {
      question:
        "How do you ensure that your CSS is scalable and maintainable for large projects?",
      answer:
        "We can ensure that our CSS is scalable and maintainable for large project by:",
      explanation:
        "1. Using proper naming convection for ID and classes. 2. Using preprocessor like sass, less, etc. 3. Using performance enhancing techniques like lazy-loading, etc.",
    },
  ],
  Javascript: [
    {
      question:
        "How do you use CSS variables to create more flexible and dynamic designs, and what are some use cases where variables are particularly useful?",
      answer:
    ...
    },
    {
      ...
      answer:
        "| slice                                        |                     splice                      |",
      explanation:
        "| -------------------------------------------- | :---------------------------------------------: | | Doesn't modify the original array(immutable) |      Modifies the original array(mutable)       | | Returns the subset of original array         |      Returns the deleted elements as array      | | Used to pick the elements from array         | Used to insert or delete elements to/from array |",
    },
    {
      question: "What are arrow function?",
      answer:
    ...
    {
      question: "What are first class function?",
      answer:
    ...
    },
    {
      ...
      explanation:
        '``` function outer() { var name = "John"; function inner() { console.log("Hello " + name); } return inner; }  var greeting = outer(); greeting(); // Output: "Hello John" ```',
    },
    {
    ...
    {
      question: "What is a callback hell in javascript?",
      answer:
    ...
    },
    {
      ...
      explanation:
        "| --------------------------------- | ---------------------------------- | ---------------- | ------------------- | | Accessed on client or server side | Both server-side & client-side     | client-side only | client-side only    | | Lifetime                          | As configured using Expires option | until deleted    | until tab is closed | | SSL support                       | Supported                          | Not supported    | Not supported       | | Maximum data size                 | 4KB                                | 5 MB             | 5MB                 |",
    },
    {
    ...
    {
      question: "How do you find operating system details in javascript?",
      answer:
    ...
    {
      question: "What is the difference between the DOM and HTML?",
      answer:
    ...
    {
      question:
        "What is the difference between the DOMContentLoaded event and the load event?",
      answer:
    ...
    {
      question: "What is the role of the Window object in the DOM?",
      answer:
    ...
    {
      question: "What is a DOM node in JavaScript?",
      answer:
    ...
    {
      question:
        "How do you prevent default behavior of an event in the DOM using JavaScript?",
      answer:
    ...
    {
      question: "What is call stack in javascript?",
      answer:
    ...
    {
      question: "What is the purpose of clearTimeout method and clearInterval?",
      answer:
    ...
    },
    {
      ...
      explanation:
        'Example:  ``` // Redirect to a new page window.location.assign("https://www.example.com");  // Redirect to a new page and replace the current page in the browser history window.location.replace("https://www.example.com"); ```  # Day 40',
    },
    {
    ...
    {
      question:
        "What is the difference between dot notation and bracket notation when accessing properties of an object?",
      answer:
    ...
    {
      question: "How would you clone an object in JavaScript?",
      answer: "There are four ways to clone an object in javascript. They are:",
      explanation:
        '1. Use the spread operator. 2. Call the Object.assign() function. 3. Use JSON parsing. 4. Use the structuredClone() function.  ``` const data = { name: "Alice", age: 26 } // 1 const copy1 = { ...data } // 2 const copy2 = Object.assign({}, data) // 3 const copy3 = JSON.parse(JSON.stringify(data)) // 4 const copy4 = structuredClone(data) ```',
    },
    {
      question: "What is a JSON?",
      answer:
    ...
    {
      question: 'What is "this" in javascript Classes?',
      answer:
    ...
    {
      question: "What is composition in classes in JavaScript?",
      answer:
    ...
    {
      question: "What is inheritance in classes in javascript?",
      answer:
    ...
    {
      question:
        "What is the `extends` keyword in JavaScript, and how is it used for inheritance?",
      answer:
      ...
      explanation:
        "``` class ChildClass extends ParentClass { // ChildClass methods and properties } ```",
    },
    {
      question: "what is the purpose of `super()` in javascript classes?",
      answer:
    ...
    {
      question: "What is a private class field in JavaScript?",
      answer:
    ...
    {
      question:
        "Can you explain the concept of encapsulation in JavaScript classes?",
      answer:
    ...
    {
      question: "What is `get` keyword in javascript classes?",
      answer:
    ...
    {
      question: "What is `set` keyword in javascript classes?",
      answer:
    ...
    {
      question:
        "Can you explain the concept of instance variables in a class in JavaScript?",
      answer:
    ...
    {
      question: "What is abstract class in javascript?",
      answer:
    ...
    {
      question:
        "How would you convert an object to a JSON string in JavaScript, and vice versa?",
      answer:
    ...
    {
      question:
        "Can you explain the concept of polymorphism in classes in JavaScript?",
      answer:
    ...
    },
    {
      ...
      explanation: '``` MyConstructor.prototype.myProperty = "some value"; ```',
    },
    {
      question:
    ...
    },
    {
      ...
      explanation:
        "``` // Check if person inherits from the Object.prototype console.log(Object.prototype.isPrototypeOf(person)); // Outputs true if it inherits or else false ```",
    },
    {
      question:
        "How do you override a method in an object's prototype in JavaScript?",
      answer:
    ...
    {
      question:
        "What is the difference between Object.create() and new Object() in JavaScript?",
      answer:
    ...
    {
      question: "What is the syntax for creating a regular expression pattern?",
      answer:
      ...
      explanation:
        "``` // Define the regex pattern const pattern = /\\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Z|a-z]{2,}\\b/; ```",
    },
    {
      ...
      explanation:
        "``` // Define the regex pattern using a character class const pattern = /[aeiou]/; ```",
    },
    {
      question:
        "What is the difference between the asterisk () and the plus sign (+) in regular expressions?",
      answer:
      ...
      explanation:
        'For example, if we want to match the letter "a" followed by zero or more "b" characters, we would use the asterisk in our regular expression like this: /ab\\*/. This would match strings like "a", "ab", "abb", "abbb", and so on.  On the other hand, if we want to match the letter "a" followed by one or more "b" characters, we would use the plus sign in our regular expression like this: /ab+/  # Day 48',
    },
    {
      question: "How do you use the question mark (?) in regular expressions?",
      answer:
    ...
    {
      question: "What is the purpose of backslashes () in regular expressions?",
      answer:
    ...
    {
      question:
        "What is the difference between a greedy and a non-greedy match in regular expressions?",
      answer:
    ...
    {
      question: "How do you use the pipe (|) operator in regular expressions?",
      answer:
    ...
    {
      question: "What are some common use cases for regular expressions?",
      answer:
    ...
    {
      question:
        "How do you match a specific number of characters in a regular expression?",
      answer:
    ...
    {
      question:
        "How do you match a specific character that has a special meaning in a regular expression?",
      answer:
    ...
    {
      question: "How do you use lookarounds in regular expressions?",
      answer:
    ...
    {
      question: "What is the `window.location` object in JavaScript?",
      answer:
    ...
    {
      question: "What are the properties of the `window.location` object?",
      answer: "Some of the properties of the window.location object are:",
      explanation:
    ...
    {
      question:
        "How do you redirect to another page using JavaScript's `window.location` object?",
      answer:
        "We can redirect to another page using the `assign()` method of the `window.location` object.",
      explanation: '``` window.location.assign("https://www.google.com"); ```',
    },
    {
      question:
        "How do you reload the current page using JavaScript's `window.location` object?",
      answer:
        "You can reload the current page using the reload() method of the window.location object.",
      explanation: "``` window.location.reload(); ```",
    },
    {
      question:
        "How do you get the value of a query parameter from the URL using JavaScript's `window.location` object?",
      answer:
      ...
      explanation:
        '``` const id = new URLSearchParams(window.location.search).get("id"); ```  # Day 51',
    },
    {
      question: "What is the Date object in JavaScript?",
      answer:
    ...
    {
      question: "How do you format a date in JavaScript?",
      answer:
      ...
      explanation:
        "``` let date = new Date(); let formattedDate = date.toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' }); console.log(formattedDate); // Output: \"05/14/2023\" ```",
    },
    {
      question: "How do you compare two dates in JavaScript?",
      answer:
      ...
      explanation:
        "``` let date1 = new Date('2023-05-14'); let date2 = new Date('2023-05-15');  if (date1 < date2) { console.log('date1 is earlier than date2'); } else { console.log('date1 and date2 are equal'); } ```",
    },
    {
      question: "How do you get the current timestamp in JavaScript?",
      answer:
    ...
    {
      question: "How do you add or subtract days to a date in JavaScript?",
      answer:
      ...
      explanation:
        "``` let date = new Date(); date.setDate(date.getDate() + 3); console.log(date); // Output: the date 3 days from now ```  # Day 52",
    },
    {
    ...
    {
      question: "What is decorator in javascript?",
      answer:
    ...
    {
      question:
        "What does the variable environment in JavaScript's function execution context contain, and what is its purpose?",
      answer:
    ...
    {
      question:
        "What is a scope chain in JavaScript's function execution context?",
      answer:
    ...
    },
    {
      ...
      explanation:
        "``` import('module.js') .then(module => { // Use the imported module // ... }) .catch(error => { // Handle any import errors // ... }); ```",
    },
    {
    ...
    },
    {
      ...
      explanation:
        '``` let cities = ["Singapore", "Delhi", "London"]; cities.length = 0; // cities becomes [] ```  # Day 55',
    },
    {
    ...
    },
    {
      ...
      explanation:
        "``` function partyGuests(...names) { console.log(names); }  partyGuests('Alice', 'Bob', 'Charlie'); ```",
    },
    {
      ...
      explanation:
        "``` const fruits = ['apple', 'banana', 'orange']; const fruitSalad = ['kiwi', 'grape', ...fruits, 'melon']; //fruitSalad = [\"kiwi\", \"grape\", \"apple\", \"banana\", \"orange\", \"melon\"] ```  # Day 56",
    },
    {
      question:
    ...
    {
      question:
        "What's the difference between Native objects and Host objects?",
      answer:
    ...
    {
      question: "What is the difference between a prototype and an instance?",
      answer:
    ...
    {
      question: "What is the difference between a module and a library?",
      answer:
    ...
    {
      question:
        "What are the different ways to delete a variable in JavaScript?",
      answer:
        "We can delete a variable and remove it from memory in the following ways:",
      explanation:
        "1. Using the `delete` keyword:  ``` let x = 10; console.log(x); // Output: 10  delete x; console.log(x); // Output: 10 (variable still exists but with no value) ```  2. Setting the variable to `undefined` or `null`:  ``` let x = 10; console.log(x); // Output: 10  x = undefined; console.log(x); // Output: undefined ```  3. Using a block scope with `let` or `const`:  ``` //Variables declared with let or const within a block scope will automatically be removed // from memory once the block is exited. { let x = 10; console.log(x); // Output: 10 }  console.log(x); // Output: ReferenceError: x is not defined ```  # Day 58",
    },
    {
      question: "What are the different types of errors in JavaScript?",
      answer: "There are three types of errors:",
      explanation:
        "1. Load time errors: Errors that come up when loading a web page, like improper syntax errors, are known as Load time errors and generate the errors dynamically. 2. Runtime errors: Errors that come due to misuse of the command inside the HTML language. 3. Logical errors: These are the errors that occur due to the bad logic performed on a function with a different operation.",
    },
    {
    ...
    {
      question: "What is `prompt()` in javascript?",
      answer:
    ...
    {
      question: "What is a non-blocking function?",
      answer:
    ...
    {
      question: "What is typed array in javascript?",
      answer:
    ...
    },
    {
      ...
      explanation: "``` console.log(null ?? true); // true ```",
    },
    {
      question: "How do you get the status of a checkbox with javascript?",
      answer:
    ...
    {
      question: "What are the different ways to debug JavaScript code?",
      answer:
    ...
    {
      question: "What are the different ways to optimize JavaScript code?",
      answer:
    ...
    {
      question:
        "What is statically typed and dynamically typed language and is javascript a statically typed or a dynamically typed language?",
      answer:
    ...
    },
    {
      ...
      explanation:
        "``` // Normal function function sum(a, b) { return a + b; }  // Curried function function currySum(a) { return function (b) { return a + b; } } ```",
    },
    {
      question: "What does delete do in JavaScript?",
      answer:
    ...
    {
      question:
        "How does control flow function in js play a role in asynchronous operation in javascript?",
      answer:
    ...
    {
      question: "Can you access DOM in nodejs?",
      answer:
    ...
    },
    {
      ...
      explanation:
        '``` class Person { constructor(name) { this.name = name; } }  const john = new Person("John");  console.log(john instanceof Person); // Output: true console.log(john instanceof Object); // Output: true (all objects inherit from Object)  const str = "Hello"; console.log(str instanceof String); // Output: false (str is a primitive string, not an instance of the String constructor) ```  # Day 64',
    },
    {
      question: "What are the drawbacks of prototypal inheritance?",
      answer:
    ...
    {
      question:
        "What are some common problems that you encounter when using regular expressions?",
      answer:
    ...
    {
      question:
        'What are the limitations of using the "var" keyword in JavaScript?',
      answer:
    ...
    {
      question:
        'What are the limitations of using the "this" keyword in JavaScript?',
      answer:
    ...
    {
      question:
        'What are the drawbacks of using the "delete" operator in JavaScript?',
      answer:
    ...
    {
      question: "What are the advantages of using closures in JavaScript?",
      answer:
    ...
    {
      question:
        "How does the concept of prototypal inheritance benefit JavaScript developers?",
      answer:
    ...
    {
      question:
        "How does using template literals in JavaScript improve string manipulation and concatenation compared to traditional methods?",
      answer:
    ...
    {
      question:
        "What are the advantages of using the fetch API over traditional XMLHttpRequest for making HTTP requests in JavaScript?",
      answer:
    ...
    {
      question:
        'Can you explain the benefits of using the "this" keyword and how it differs in different contexts in JavaScript?',
      answer:
    ...
    {
      question:
        "What resources or techniques do you use to stay up to date with the latest developments in JavaScript?",
      answer:
    ...
    {
      question:
        "How do you ensure the code you write is maintainable, readable, and follows best practices?",
      answer:
    ...
    {
      question:
        "How do you handle working on a JavaScript project with a large codebase or multiple developers?",
      answer:
  ...
  ReactJS: [
    {
      question:
        "According to javascript array, what comes first the chicken or egg?",
      answer:
        'According to the JavaScript array, "chicken" comes before "egg" because "chicken" is alphabetically sorted before "egg".',
      explanation:
        '``` const arr = ["egg", "chicken"]; const sortedArr = arr.sort();  console.log(sortedArr) // ["chicken", "egg"]  //Hence proved, chicken comes first than egg ```  ReactJS  # Day 67',
    },
    {
    ...
    {
      question:
        "What is the difference between ReactJS and other JavaScript frameworks/libraries?",
      answer:
    ...
    {
      question: "Explain the concept of virtual DOM in ReactJS.",
      answer:
    ...
    {
      question: "What are the components in ReactJS?",
      answer:
    ...
    {
      question: "What is the significance of state in ReactJS?",
      answer:
    ...
    {
      question:
        "What are the lifecycle methods in ReactJS and how do they work?",
      answer:
    ...
    {
      question:
        "Explain the concept of controlled and uncontrolled components in ReactJS.",
      answer:
    ...
    {
      question:
        'What is the purpose of the "setState" method in ReactJS and how does it work?',
      answer:
    ...
    {
      question: 'What is the significance of the "React.Fragment" component?',
      answer:
    ...
    {
      question:
        "What are the differences between class components and functional components in ReactJS?",
      answer:
    ...
    {
      question: "Explain the Flux architectural pattern.",
      answer:
    ...
    {
      question: "Explain the concept of context in React. How does it work?",
      answer:
    ...
    {
      question: "What are portals in React? When would you use them?",
      answer:
    ...
    {
      question:
        "What is the role of the useReducer hook in React? How does it differ from the useState hook?",
      answer:
    ...
    {
      question:
        "What is the purpose of the useMemo hook? How does it help optimize performance in React?",
      answer:
    ...
    {
      question:
        "When would you use the useCallback hook in React? How does it differ from the useMemo hook?",
      answer:
    ...
    {
      question: "## How can we avoid prop drilling?",
      answer:
    ...
    {
      question: "Why we should not update state directly?",
      answer:
    ...
    {
      question: "What's wrong with using Context in React?",
      answer:
    ...
    {
      question: "Explain why and when would you use `useMemo()`?",
      answer:
    ...
    {
      question: "When shall we use useReducer hook in ReactJS?",
      answer:
    ...
    {
      question: "what are styled component?",
      answer:
    ...
    {
      question: "Why props cannot be updated in ReactJS?",
      answer:
    ...
    {
      question: "Is React a library or a Framework and why?",
      answer:
    ...
    {
      question: "What are nested component in react?",
      answer:
    ...
    {
      question:
        "Can a nested child component access the state of its sibling component?",
      answer:
    ...
    {
      question: "What is React Dev Tool?",
      answer:
    ...
    {
      question: 'What is "React Node" in react?',
      answer:
    ...
    {
      question:
        'Can you explain React\'s "lifting state up" concept and why it is important?',
      answer:
    ...
    {
      question: "What is a ref in React and what is its purpose?",
      answer:
    ...
    {
      question: "How does using refs differ from traditional DOM manipulation?",
      answer:
    ...
    {
      question:
        'What is the main difference between "string refs" and "callback refs" in React.',
      answer:
    ...
    {
      question: 'Explain the concept of "forwarding refs" in React.',
      answer:
    ...
    {
      question: "How do refs affect the component lifecycle in React?",
      answer:
    ...
    {
      question:
        "What are the benefits of using callback refs over string refs?",
      answer:
    ...
    {
      question:
        "Can we use refs with functional components in React? If yes, how?",
      answer:
    ...
    {
      question: "What are the limitations or caveats of using refs in React?",
      answer:
    ...
    {
      question:
        "How do you clean up or release the resources associated with a ref in React?",
      answer:
    ...
    {
      question: "How do you access the DOM node using refs in React?",
      answer:
    ...
    {
      question: "What is binding in React and why is it important?",
      answer:
    ...
    {
      question:
        "What happens if you don't bind a function in React? Explain the potential issues that can arise.",
      answer:
    ...
    {
      question:
        "How can you bind a function in a React class component? Describe the different methods available.",
      answer:
    ...
    {
      question:
        "What is the recommended approach for binding functions in React components?",
      answer:
    ...
    {
      question:
        "Explain the difference between binding in class components and functional components in React.",
      answer:
    ...
    {
      question: "Why is a React component declarative?",
      answer:
    ...
    {
      question: "What is ReactDOM package?",
      answer:
    ...
    {
      question:
        "Can you explain what custom hooks are in React and how they differ from regular hooks?",
      answer:
    ...
    {
      question:
        "What are the benefits of using custom hooks in React? Can you provide an example of a scenario where a custom hook would be useful?",
      answer:
    ...
    {
      question:
        "Are there any limitations or considerations when using custom hooks in React? Are there any performance implications or potential pitfalls that developers should be aware of?",
      answer:
    ...
    {
      question:
        "What is Formik, and why would you use it in a React application?",
      answer:
    ...
    {
      question:
        "What are the advantages of using Formik over traditional form handling in React?",
      answer:
    ...
    {
      question:
        "What is Axios, and what problem does it solve in JavaScript or React development?",
      answer:
    ...
    {
      question:
        "What are the advantages of using Axios over the built-in fetch API in JavaScript?",
      answer:
    ...
    {
      question:
        "What is Material-UI, and what is its purpose in React development?",
      answer:
    ...
    },
    {
      ...
      explanation:
        '``` const MyComponent = () => { return React.createElement("div", { className: "my-class" }, "Hello, World!"); }; ```',
    },
    {
    ...
    {
      question:
        "How does React Fiber improve the overall performance of React applications?",
      answer:
    ...
    {
      question: "What is a wrapper component in react?",
      answer:
    ...
    {
      question:
        "What are the dependencies in the dependency array of the useEffect hook? How do they affect the behavior of the hook?",
      answer:
    ...
    {
      question: "What are some common use cases for the useEffect hook?",
      answer:
    ...
    {
      question:
        "Can you explain the concept of multiple useEffect hooks in a single component? How do they interact with each other?",
      answer:
    ...
    {
      question:
        "## What is the purpose of the cleanup function returned by the useEffect hook? How can you utilize it effectively?",
      answer:
      ...
      explanation:
        "``` useEffect(() => { const timerId = setInterval(() => { console.log('Running effect...'); }, 1000);  return () => { // Cleanup function: Clear interval when component unmounts clearInterval(timerId); }; }, []); ```",
    },
    {
      question:
    ...
    {
      question: "What is server-side rendering (SSR) in React.js?",
      answer:
    ...
    {
      question:
        "Why would you choose to use server-side rendering instead of client-side rendering in React.js?",
      answer:
    ...
    {
      question:
        "How does server-side rendering differ from client-side rendering in React.js?",
      answer:
    ...
    {
      question:
        "Explain the benefits and drawbacks of server-side rendering in React.js.",
      answer:
    ...
    {
      question:
        "What are the performance implications of server-side rendering in React.js?",
      answer:
    ...
    {
      question:
        "How can you implement server-side rendering with React.js without using frameworks like Next.js?",
      answer:
    ...
    {
      question:
        "Describe the steps involved in setting up server-side rendering with React.js from scratch.",
      answer:
    ...
    {
      question:
        "What libraries or tools can be used to perform server-side rendering with React.js?",
      answer:
    ...
    {
      question:
        "How can you handle data fetching and asynchronous operations during server-side rendering in React.js?",
      answer:
    ...
    {
      question:
        "What considerations should you keep in mind when implementing server-side rendering for a large-scale React.js application?",
      answer:
    ...
    {
      question:
        "Can you explain the concept of code splitting and how it relates to server-side rendering in React.js?",
      answer:
    ...
    {
      question:
        "How can you optimize server-side rendered React.js applications for search engine optimization (SEO)?",
      answer:
    ...
    {
      question:
        "What are some common challenges or pitfalls associated with server-side rendering in React.js, and how can you address them?",
      answer:
    ...
    {
      question:
        "How does server-side rendering impact the development and debugging process compared to client-side rendering?",
      answer:
    ...
    {
      question:
        "Can you explain the concept of hydration in the context of server-side rendering in React.js?",
      answer:
    ...
    {
      question:
        "What are the best practices for organizing and structuring a React application?",
      answer:
    ...
    {
      question:
        "What are the pros and cons of using React in a project compared to other JavaScript frameworks?",
      answer:
    ...
    {
      question: "Why do we need Nextjs?",
      answer:
  ...
  Typescript: [
    {
      question:
        "What are some of the challenges you have faced working with React?",
      answer: "&nbsp; &nbsp; &nbsp; <b> Write your own answer </b>",
      explanation: "Typescript  # Day 94",
    },
    {
    ...
    {
      question:
        "How do you define variables with specific types in TypeScript?",
      answer:
    ...
    {
      question: "What is tuple datatype in TypeScript?",
      answer:
    ...
    {
      question:
        "What is the purpose of type annotations in TypeScript, and how are they used?",
      answer:
    ...
    {
      question: "How can you define custom types or interfaces in TypeScript?",
      answer:
    ...
    {
      question:
        "Explain the concept of type inference in TypeScript and how it works.",
      answer:
    ...
    {
      question:
        "What is the difference between interfaces and type aliases in TypeScript? When would you use one over the other?",
      answer:
    ...
    {
      question:
        "How does TypeScript support class-based object-oriented programming?",
      answer:
    ...
    {
      question: "Explain the concept of type assertion in TypeScript.",
      answer:
    ...
    {
      question: "How can you enforce strict null checks in TypeScript?",
      answer:
    ...
    {
      question:
        'What is the "readonly" modifier in TypeScript, and how does it affect properties and arrays?',
      answer:
    ...
    {
      question: "Can TypeScript be used for the backend?",
      answer:
    ...
    {
      question: "what is optional properties in an interface in TypeScript?",
      answer:
      ...
      explanation:
        "``` //age & email are marked as optional so it will not cause any error if they're not assigned any value interface Person { name: string; age?: number; email?: string; } ```",
    },
    {
      ...
      explanation:
        '``` function identity<T>(arg: T): T { return arg; } //this is how generics increase flexibility  let result1 = identity<number>(42); // result1 is of type number let result2 = identity<string>("Hello"); // result2 is of type string ```',
    },
    {
    ...
    },
    {
      ...
      explanation:
        "``` interface Person { name: string; age: number; }  type PersonKeys = keyof Person; const key1: PersonKeys = 'name'; //Valid key const key3: PersonKeys = 'address'; //Error ```  # Day 98",
    },
    {
      question:
        'Explain the difference between "interface" and "class" in TypeScript.',
      answer:
    ...
    {
      question: "Can you erase the values of array elements in TypeScript?",
      answer:
    ...
    {
      question: "What is Intersection types in Typescript?",
      answer:
      ...
      explanation:
        '``` interface A { propA: number; }  interface B { propB: string; }  type IntersectionType = A & B;  const obj: IntersectionType = { propA: 123, propB: "hello", }; ```',
    },
    {
      question: "What is Union types in Typescript?",
      answer:
        'Union types allow you to define a type that can hold values of multiple types. It is denoted by the "|" symbol.',
      explanation:
        '``` type UnionType = string | number;  let val: UnionType; val = "hello"; // Valid val = 123;     // Valid val = true;    // Error, as boolean is not part ```  # Day 99',
    },
    {
      question: "Which TypeScript types are immutable?",
      answer:
    ...
    {
      question: "What is mixins in Typescript?",
      answer:
    ...
    },
    {
      ...
      explanation:
        "``` interface Box { height: number; width: number; } interface Box { scale: number; } let box: Box = { height: 5, width: 6, scale: 10 }; ```  # Day 100",
    },
    {
    ...
    {
      question: "What are the best practices when using TypeScript?",
      answer:
